...
"""]
#-----Pre-scoring-----
merge_insert_prescoring_cache=[f"""merge into {DATABASE}.activity.prescoring_cache t
using (
select activity.*,
        taxo.intent_topics,
...
delete_from_company_activity_cache=[f"""delete from {DATABASE}.activity.company_activity_cache a
